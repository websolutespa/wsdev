...
- `<name>.stories.js` present with documented `argTypes`, `Default`, a `Catalog` covering every mock scenario, all rendering in Storybook; a `play` story for every component with a module.
