...
function cloneNode(html) {
  ...
  node.querySelector('.display-2').innerText = 'Another Lazy Module';
  node.querySelector('.display-4').innerText = 'I\'m another lazy loaded module';
  const color = getRandomColor();
  node.style.setProperty('--color-lazy', color);
